...
def on_info_button(item):
    ...
    if installButtonTxt == 'Install' or installButtonTxt == 'Remove':
    ...
    if installButtonTxt == 'Uninstall':
      ...
      on_cell_toggle()
      # Uninstall item
      if tkMessageBox.askyesno(appName, u"Are you sure you would like to Uninstall \n\n\u25cf  "+titleList[item], icon='question'):
        uninstallSoftwareItems()    
      else:
        # De-Select item
